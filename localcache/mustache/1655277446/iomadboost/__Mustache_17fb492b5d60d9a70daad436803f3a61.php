...
class __Mustache_17fb492b5d60d9a70daad436803f3a61 extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($partial = $this->mustache->loadPartial('theme_iomadboost/head')) {
...
';
        $buffer .= $indent . '
';
        if ($partial = $this->mustache->loadPartial('theme_iomadboost/navbar')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        if ($partial = $this->mustache->loadPartial('theme_iomadboost/nav-drawer')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        $buffer .= $indent . '
';
...
';
        ...
        $buffer .= '
';
        if ($partial = $this->mustache->loadPartial('theme_iomadboost/footer')) {
            $buffer .= $partial->renderInternal($context, $indent . '    ');
        }
        $buffer .= $indent . '</div>
';
...
';
        ...
        $buffer .= $this->section5b4cbed5af902cc34d40fa7ba0c82f5c($context, $indent, $value);
...
';
    ...
    private function section5b4cbed5af902cc34d40fa7ba0c82f5c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
...
M.util.js_pending(\'theme_iomadboost/drawer\');
require([\'theme_iomadboost/drawer\'], function(mod) {
    mod.init();
  M.util.js_complete(\'theme_iomadboost/drawer\');
});
';
            $result = call_user_func($value, $source, $this->lambdaHelper);
            if (strpos($result, '{{') === false) {
            ...
            foreach ($values as $value) {
                ...
                $buffer .= $indent . 'M.util.js_pending(\'theme_iomadboost/loader\');
';
                $buffer .= $indent . 'require([\'theme_iomadboost/loader\'], function() {
';
                $buffer .= $indent . '  M.util.js_complete(\'theme_iomadboost/loader\');
';
                $buffer .= $indent . '});
';
                $buffer .= $indent . 'M.util.js_pending(\'theme_iomadboost/drawer\');
';
                $buffer .= $indent . 'require([\'theme_iomadboost/drawer\'], function(mod) {
';
                $buffer .= $indent . '    mod.init();
';
                $buffer .= $indent . '  M.util.js_complete(\'theme_iomadboost/drawer\');
';
                $buffer .= $indent . '});
';
                $context->pop();
